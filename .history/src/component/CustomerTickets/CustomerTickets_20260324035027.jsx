...
const CustomerTickets = ({customerPromise}) => {
  ...
  <div className="card-body">
    <div className='flex justify-between'>
     ...
     <button className='rounded-4xl bg-[#B9F8CF] w-[70px] h-[30px] flex items-center gap-1 p-2 font-medium text-[15px]'><span className='bg-[#02A53B] rounded-full w-2 h-2'></span>Open</button>
